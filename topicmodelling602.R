...
corpus_602 <- mp_corpus(countryname == "Germany" & edate > as.Date("1990-01-01"), codefilter = c(602.2))
head(codes(corpus_602))
print(corpus_602)
meta(corpus_602)
write.csv(corpus_602, "corpus_602.csv")
print(corpus_602)

textdata<-read.csv("C:/R/DigitalHumanities/manifesto1/corpus_602.csv",sep= ",",encoding="UTF-8")
...
top10_terms<-c("deutschland", "europa", "schaff", "off", "sich", "leb", "jahr", "deutsch")
...
beta<-tmResult$terms #getbetafromresults
